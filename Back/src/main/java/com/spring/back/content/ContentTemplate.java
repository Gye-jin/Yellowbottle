...
public class ContentTemplate {
	...
	public static String contentTemplate(Content content1, Content content2, Content content3) {
		...
		String czeroURL = "http://localhost/";
		String imageURL = "https://png.pngtree.com/thumb_back/fh260/back_our/20190621/ourmid/pngtree-protect-earth-fresh-banner-poster-background-image_188567.jpg";
		...
		String tp = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r\n"
				...
				+ "        \r\n"
				+ "  <h1 class=\"v-font-size\" style=\"margin: 0px; line-height: 130%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: Epilogue; font-size: 32px;\"><strong>Hello<br />Yellowbottle</strong></h1>\r\n"
				+ "\r\n" + "      </td>\r\n" + "    </tr>\r\n" + "  </tbody>\r\n" + "</table>\r\n" + "\r\n"
				...
				+ "      \r\n"
				+ "      <img align=\"center\" border=\"0\" src= "+imageURL+" alt=\"\" title=\"\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 55%;max-width: 319px;\" width=\"319\" class=\"v-src-width v-src-max-width\"/>\r\n"
				+ "      \r\n" + "    </td>\r\n" + "  </tr>\r\n" + "</table>\r\n" + "\r\n" + "      </td>\r\n"
				+ "    </tr>\r\n" + "  </tbody>\r\n" + "</table>\r\n" + "\r\n"
				+ "  <!--[if (!mso)&(!IE)]><!--></div><!--<![endif]-->\r\n" + "  </div>\r\n" + "</div>\r\n"
				+ "<!--[if (mso)|(IE)]></td><![endif]-->\r\n"
